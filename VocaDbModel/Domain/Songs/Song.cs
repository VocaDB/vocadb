...
namespace VocaDb.Model.Domain.Songs {
	...
	public class Song : IEntryBase, IEntryWithNames<SongName>, IEntryWithArtistLinks<ArtistForSong>, 
		...
		private IList<LyricsForSong> GetLyricsFromParents(ISpecialTags specialTags, IEntryTypeTags entryTypeTags, bool allowInstrumental, int levels) {
		...
		/// </summary>
		/// <param name="specialTags">Special tags. Can be null, which will cause no lyrics to be inherited.</param>
		public virtual IList<LyricsForSong> GetLyricsFromParents(ISpecialTags specialTags, IEntryTypeTags entryTypeTags) {
