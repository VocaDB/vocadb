	...
	IEntryWithArtists
{
	...
	[return: NotNullIfNotNull(nameof(barcode))]
	...
	public virtual async Task<CollectionDiffWithValue<ArtistForAlbum, ArtistForAlbum>> SyncArtists(
		IEnumerable<ArtistForAlbumContract> newArtists,
		Func<ArtistContract, Task<Artist>> artistGetter
	)
	{
	...
	public virtual async Task<CollectionDiffWithValue<SongInAlbum, SongInAlbum>> SyncSongs(
		IEnumerable<SongInAlbumEditContract> newTracks,
		Func<SongInAlbumEditContract, Task<Song>> songGetter,
