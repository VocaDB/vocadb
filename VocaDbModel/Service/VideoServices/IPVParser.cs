...
namespace VocaDb.Model.Service.VideoServices {
	...
	public interface IPVParser {
		...
		Task<VideoUrlParseResult> ParseByUrlAsync(VocaDbUrl url, bool getTitle, IUserPermissionContext permissionContext);
		...
		/// <param name="permissionContext">Permission context. Can be null (if the user is not logged in).</param>
		/// <returns>Result of PV parsing. Cannot be null.</returns>
		Task<VideoUrlParseResult[]> ParseByUrlsAsync(IEnumerable<VocaDbUrl> urls, bool getTitle, IUserPermissionContext permissionContext);

	}

	public class PVParser : IPVParser {
		public Task<VideoUrlParseResult> ParseByUrlAsync(VocaDbUrl url, bool getTitle, IUserPermissionContext permissionContext) => VideoServiceHelper.ParseByUrlAsync(url, getTitle, permissionContext);
