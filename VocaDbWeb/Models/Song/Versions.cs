...
namespace VocaDb.Web.Models.Song
{
	...
	{
		public static ArchivedObjectVersion CreateForSong(ServerOnlyArchivedSongVersionContract song)
		{
		...
		public Versions(ServerOnlySongWithArchivedVersionsContract contract)
		{
