...
module vdb.viewModels {
	...
	export class DeletedAlbumsViewModel {
		...
		private updateResults = (clearResults: boolean) => {
			...
			this.albumRepo.getList(pagingProperties, this.albumRepo.languagePreferenceStr, null, "Name", undefined, null,
				null, undefined, undefined, "AdditionalNames,MainPicture", null, true, result => {
