...
const SongListImport = observer((): React.ReactElement => {
			...
			{importSongListStore.parsed && (
				<div>
					...
					<table className="table table-condensed">
						<thead>
							<tr>
								<th>{t('VocaDb.Web.Resources.Views.SongList:Import.Order')}</th>
								<th>
									{t('VocaDb.Web.Resources.Views.SongList:Import.NicoPV')}
								</th>
								<th>
									{t('VocaDb.Web.Resources.Views.SongList:Import.VocaDbEntry')}
								</th>
							</tr>
						</thead>
						<tbody>
