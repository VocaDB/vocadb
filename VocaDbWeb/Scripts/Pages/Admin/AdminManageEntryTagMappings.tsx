...
const AdminManageEntryTagMappings = observer((): React.ReactElement => {
	return (
		<Layout
			pageTitle={undefined}
			ready={true}
				...
				<div className="control-group">
					...
					<div className="controls">
						<select
							...
							onChange={(e): void =>
								runInAction(() => {
									manageEntryTagMappingsStore.newEntrySubType = e.target.value;
								})
							}
						>
							<option value="" />
							{manageEntryTagMappingsStore.entrySubTypes.map((entrySubType) => (
