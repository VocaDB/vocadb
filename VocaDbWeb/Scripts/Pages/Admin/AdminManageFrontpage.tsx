...
const AdminManageFrontpage = observer((): React.ReactElement => {
		...
		>
			...
			>
				...
				<p className="text-muted">
					Configure announcement banners displayed on the homepage. Banners are
					shown in order when enabled.{/* LOC */}
				</p>
						...
						<div className="form-group">
							...
							<input
								...
								onChange={async (e): Promise<void> => {
									...
									if (file) {
										try {
											const fileName = await manageFrontpageStore.uploadImage(
												file,
											);
											runInAction(() => {
						...
						<div className="btn-group" style={{ marginTop: '10px' }}>
							...
							<Button
								...
								onClick={(): void => {
									if (
										confirm(
											'Are you sure you want to remove this banner?' /* LOC */,
										)
									) {
