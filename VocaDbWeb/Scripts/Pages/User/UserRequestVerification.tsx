...
const UserRequestVerification = observer((): React.ReactElement => {
	const vdb = useVdb();
			...
			<div className="row-fluid">
				{loginManager.isLoggedIn ? (
					...
					>
						...
						<br />
						<label>{t('ViewRes.User:RequestVerification.MessageTitle')}</label>
						<textarea
							className="span11"
							cols={50}
							rows={10}
				...
				<Alert variant="info" className="span4">
					<span
						dangerouslySetInnerHTML={{
							__html: tBrand('UserRes.RequestVerificationInfo'),
						}}
					/>
				</Alert>
			</div>
