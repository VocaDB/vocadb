...
module vdb.utils {
    ...
    export class WebLinkMatcher {
		...
		static matchers: WebLinkMatcher[] = [
			{ url: "5sing.kugou.com/", desc: "5SING", cat: c.WebLinkCategory.Official },
			...
			{ url: "lofter.com/", desc: "Blog on Lofter", cat: c.WebLinkCategory.Official },
			...
			{ url: "w.atwiki.jp/hmiku/", desc: "MikuWiki", cat: c.WebLinkCategory.Reference },
			...
			{ url: "music.163.com/#/user/home", desc: "NCM User Homepage", cat: c.WebLinkCategory.Official },
			{ url: "music.163.com/#/artist", desc: "NCM Artist Entry", cat: c.WebLinkCategory.Official },
			{ url: "music.163.com/#/album", desc: "NCM Album Release", cat: c.WebLinkCategory.Official },
			{ url: "music.163.com/#/song", desc: "NCM Song Release", cat: c.WebLinkCategory.Official },
			...
			{ url: "poppro.cn/", desc: "Poppro", cat: c.WebLinkCategory.Official },
			...
			{ url: ".taobao.com", desc: "Taobao", cat: c.WebLinkCategory.Commercial },
			...
			{ url: "w.atwiki.jp/utauuuta/", desc: "UTAU Wiki (JP)", cat: c.WebLinkCategory.Reference },
			...
			{ url: "zh.moegirl.org/", desc: "Moegirlpedia (zh-cn)", cat: c.WebLinkCategory.Reference },
			{ url: "en.moegirl.org/", desc: "Moegirlpedia (EN)", cat: c.WebLinkCategory.Reference },
