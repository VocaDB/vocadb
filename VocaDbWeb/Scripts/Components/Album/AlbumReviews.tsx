...
import { UserLanguageCultureDropdownList } from '../Shared/Partials/Knockout/DropdownList';
import MarkdownNotice from '../Shared/Partials/Shared/MarkdownNotice';
import IconAndLinkKnockout from '../Shared/Partials/User/IconAndLinkKnockout';
import NameLinkKnockout from '../Shared/Partials/User/NameLinkKnockout';
			...
			>
				...
				<div className="album-reviews">
					{albumDetailsStore.reviewsStore.reviews.map((review, index) => (
						<div className="album-review media" key={index}>
							...
							<div className="media-body">
								...
								<span>
									{albumDetailsStore.reviewsStore
										.ratingStars(
											albumDetailsStore.reviewsStore.getRatingForUser(
												review.user.id,
											),
										)
								...
								{albumDetailsStore.reviewsStore.editReviewStore === review ? (
									...
									>
										...
										<Button
											onClick={albumDetailsStore.reviewsStore.cancelEditReview}
										>
